...
@section('contents')
    ...
    <form action="" id="profile_setup_frm" enctype="multipart/form-data" method="post">
        <div class="row">
            <div class="col-md-12 border-right">
                <div class="p-3 py5">
                    ...
                    <div class="mt-5 text-center">
                        <button id="btn" type="submit" class="btn btn-primary profile-button">Save Profile</button>
                    </div>
                </div>
            </div>
        </div>
